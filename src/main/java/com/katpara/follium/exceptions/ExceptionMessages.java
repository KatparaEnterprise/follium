...
public final class ExceptionMessages {
    ...
    public static final String INVALID_PARAMETER_PROVIDED_MESSAGE = "Null values provided";
    ...
    public static final String ROW_OUT_OF_BOUND_MESSAGE = "Can not access the row.";
